...
alias set_title='ff () { PROMPT_COMMAND="echo -ne \"\033]0;$@\007\""; }; ff $@'
alias set_screen_title='ff () { PROMPT_COMMAND="echo -ne \"\033k;$@\033\""; }; ff $@'
...
alias update_code='git --no-pager diff && echo "Press Enter if you wanna commit..." && read userInput && git commit -a --amend -C HEAD && echo && git status && echo -e "\nSynchrinizing..." && r'
